    ...
    Prism = (function (e) {
        ...
        if (
            ...
            (s.stringify = function e(t, a) {
                ...
                var s = { type: t.type, content: e(t.content, a), tag: 'span', classes: ['token', t.type], attributes: {}, language: a },
                    i = t.alias;
 ...
 */ 'undefined' != typeof module && module.exports && (module.exports = Prism),
    ...
    Object.defineProperty(Prism.languages.markup.tag, 'addInlined', {
        value: function (e, t) {
            var a = {};
            (a['language-' + t] = { pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i, lookbehind: !0, inside: Prism.languages[t] }),
                (a.cdata = /^<!\[CDATA\[|\]\]>$/i);
    ...
    (function () {
        if (void 0 !== Prism && 'undefined' != typeof document) {
                            ...
                            (p.onreadystatechange = function () {
                                ...
                                4 == p.readyState &&
                                    (p.status < 400 && p.responseText
                                        ? (i.setAttribute(t, n), (o.textContent = p.responseText), Prism.highlightElement(o))
                                        : (i.setAttribute(t, 'failed'),
                                          p.status >= 400
                                              ? (o.textContent =
                                                    ((e = p.status), (a = p.statusText), '✖ Error ' + e + ' while fetching file: ' + a))
            ...
            Prism.fileHighlight = function () {
                i || (console.warn('Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead.'), (i = !0)),
