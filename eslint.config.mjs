    ...
    },
    {
        ...
        rules: {
            ...
            '@typescript-eslint/no-magic-numbers': [
                ...
                {
                    ignore: [
                        -20, -10, -1, 0, 0.05, 0.1, 0.5, 0.7, 0.8, 1, 1.2, 1.3, 1.8, 2, 2.5, 2.9, 3, 3.7, 4, 5, 6, 7, 8, 9, 10, 20, 30, 35,
                        40, 45, 50, 60, 70, 75, 99, 100, 155, 235, 300, 360, 400, 500, 600, 700, 800, 960, 999, 1000, 1200, 3600
                    ]
                }
            ],
