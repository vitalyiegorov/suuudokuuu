...
describe('HiddenSingleTechnique', () => {
    ...
    it('should find all HiddenSingle opportunities in field', () => {
        const field = createFieldFromString(
            '.2345678.' +
                '1........' +
                '.........' +
        ...
        const hiddenSingleResults = results.filter((r) => r.technique === SolutionTechniqueEnum.HiddenSingle);

        expect(hiddenSingleResults.length).toBeGreaterThan(0);
    });
});
