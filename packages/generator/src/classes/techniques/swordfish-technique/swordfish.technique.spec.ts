...
describe('SwordfishTechnique', () => {
    ...
    const technique = new SwordfishTechnique(sudoku);
    ...
    it('should have correct type and difficulty', () => {
        expect(technique.type).toBe(SolutionTechniqueEnum.Swordfish);
        expect(technique.difficulty).toBe(13);
    });

    it('should find all Swordfish patterns in field', () => {
