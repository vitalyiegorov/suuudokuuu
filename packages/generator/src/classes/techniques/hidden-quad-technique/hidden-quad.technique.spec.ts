...
describe('HiddenQuadTechnique', () => {
    ...
    const technique = new HiddenQuadTechnique(sudoku);
    ...
    it('should have correct type and difficulty', () => {
        expect(technique.type).toBe(SolutionTechniqueEnum.HiddenQuad);
        expect(technique.difficulty).toBe(9);
    });

    it('should find all hidden quads in field', () => {
