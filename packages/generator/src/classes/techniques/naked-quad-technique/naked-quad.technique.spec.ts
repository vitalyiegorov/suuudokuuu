...
describe('NakedQuadTechnique', () => {
    ...
    const technique = new NakedQuadTechnique(sudoku);
    ...
    it('should have correct type and difficulty', () => {
        expect(technique.type).toBe(SolutionTechniqueEnum.NakedQuad);
        expect(technique.difficulty).toBe(8);
    });

    it('should find all naked quads in field', () => {
