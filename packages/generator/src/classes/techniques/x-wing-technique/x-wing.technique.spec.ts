...
describe('XWingTechnique', () => {
    ...
    const technique = new XWingTechnique(sudoku);
    ...
    it('should have correct type and difficulty', () => {
        expect(technique.type).toBe(SolutionTechniqueEnum.XWing);
        expect(technique.difficulty).toBe(12);
    });

    it('should find all X-Wings in field', () => {
