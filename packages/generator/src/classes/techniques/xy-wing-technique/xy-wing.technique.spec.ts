...
describe('XYWingTechnique', () => {
    ...
    const technique = new XYWingTechnique(sudoku);
    ...
    it('should have correct type and difficulty', () => {
        expect(technique.type).toBe(SolutionTechniqueEnum.XYWing);
        expect(technique.difficulty).toBe(15);
    });

    it('should find all XY-Wing patterns in field', () => {
