...
export const DevelopmentReleaseTagPattern = /^development-([1-9]\d*)-([1-9]\d*)-([1-9]\d*)$/u;
...
export const MaximumGithubReleasesByteLength = 4_194_304;
export const MaximumChecksumCandidateAttempts = 5;
