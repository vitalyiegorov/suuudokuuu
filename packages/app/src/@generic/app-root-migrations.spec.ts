...
describe('appRootMigrations', () => {
    ...
    it('should backfill the comfort preferences at migration 38 without touching stored choices', () => {
        expect.assertions(3);
        ...
        const migrated = runMigration(38, buildState({ settings: storedSettings }));
