...
export const MistakesSelect = ({ onSelect }: Props) => {
    ...
    return (
        <View style={styles.wrapper}>
            ...
            <BlackButton onPress={handlePress(99)} text={t`Immortal - 99`} />
            <BlackButton onPress={handlePress(3)} text={t`Standard - 3`} />
            <BlackButton onPress={handlePress(0)} text={t`Hardcore - 0`} />
        </View>
    );
};
