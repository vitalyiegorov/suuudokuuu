...
import { CELL_INDEX_BITS, TIMESTAMP_BITS, VALUE_BITS } from '../../@generic/constants/bit-encoding.constant';
import { GRID_SIZE } from '../../@generic/constants/grid.constant';
...
import type { CellPositionInterface } from '../../@generic/interfaces/cell-position.interface';
