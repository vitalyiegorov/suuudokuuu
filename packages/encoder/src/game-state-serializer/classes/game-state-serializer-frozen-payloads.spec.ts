...
describe('GameStateSerializer frozen pre-difficulty v3 payloads', () => {
    ...
    it('should decode a frozen puzzle payload with an absent difficulty', () => {
        expect.assertions(5);
    ...
    it('should decode a frozen challenge payload with an absent difficulty', () => {
        expect.assertions(7);
    ...
    it('should decode a frozen handoff payload with an absent difficulty', () => {
        expect.assertions(8);
