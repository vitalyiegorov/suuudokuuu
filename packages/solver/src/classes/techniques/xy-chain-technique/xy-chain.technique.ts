...
import { XY_CHAIN_MAX_CELLS, XY_CHAIN_MIN_CELLS } from '../../../constants/chain-scan.constant';
...
export class XYChainTechnique extends AbstractChainTechnique implements TechniqueStrategyInterface {
